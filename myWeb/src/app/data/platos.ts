...
export const PLATOS:IPlato[]=[
    ...
    },
    {
        ...
        categorias:['Legumbres'],
        comensales:4,
        ingredientes:['1 patata','1 pimiento rojo','1 pimiento verda','1 tomate','1 zanahoria','1 cebolla','2 ajos','1 cucharada de pimentón dulce','1 cucharadita de pimienta negra'],
